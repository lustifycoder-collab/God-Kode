...
val APP_EXTERNAL_DIR = "${PathUtils.getExternalStoragePath()}/GodKode"

const val ORGANIZATION_NAME = "godkode"
const val APPLICATION_REPOSITORY_NAME = "godkode"
