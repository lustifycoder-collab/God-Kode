...
package com.dev.godkode.ui.screens.editor
...
import com.dev.godkode.activities.Editor.LocalCommandPaletteManager
import com.dev.godkode.activities.Editor.LocalEditorDrawerState
import com.dev.godkode.activities.Editor.LocalEditorSnackbarHostState
import com.dev.godkode.compose.ui.EditorTab
import com.dev.godkode.compose.ui.dialog.ConfirmDialog
import com.dev.godkode.core.EventManager
import com.dev.godkode.core.ai.Gemini
import com.dev.godkode.core.settings.Settings.Editor.rememberColorScheme
import com.dev.godkode.core.settings.Settings.Editor.rememberCurrentEditor
import com.dev.godkode.core.settings.Settings.Editor.rememberDeleteIndentOnBackspace
import com.dev.godkode.core.settings.Settings.Editor.rememberDeleteLineOnBackspace
import com.dev.godkode.core.settings.Settings.Editor.rememberEditorTextActionWindowExpandThreshold
import com.dev.godkode.core.settings.Settings.Editor.rememberFontFamily
import com.dev.godkode.core.settings.Settings.Editor.rememberFontLigatures
import com.dev.godkode.core.settings.Settings.Editor.rememberFontSize
import com.dev.godkode.core.settings.Settings.Editor.rememberIndentSize
import com.dev.godkode.core.settings.Settings.Editor.rememberLineNumber
import com.dev.godkode.core.settings.Settings.Editor.rememberStickyScroll
import com.dev.godkode.core.settings.Settings.Editor.rememberUseTab
import com.dev.godkode.core.settings.Settings.Editor.rememberWordWrap
import com.dev.godkode.core.settings.Settings.File.rememberLastOpenedFile
import com.dev.godkode.core.settings.Settings.General.rememberFollowSystemTheme
import com.dev.godkode.core.settings.Settings.General.rememberIsDarkMode
import com.dev.godkode.core.settings.Settings.Monaco
import com.dev.godkode.core.settings.Settings.Monaco.rememberAcceptSuggestionOnCommitCharacter
import com.dev.godkode.core.settings.Settings.Monaco.rememberAcceptSuggestionOnEnter
import com.dev.godkode.core.settings.Settings.Monaco.rememberCursorBlinkingStyle
import com.dev.godkode.core.settings.Settings.Monaco.rememberCursorStyle
import com.dev.godkode.core.settings.Settings.Monaco.rememberFolding
import com.dev.godkode.core.settings.Settings.Monaco.rememberGlyphMargin
import com.dev.godkode.core.settings.Settings.Monaco.rememberLetterSpacing
import com.dev.godkode.core.settings.Settings.Monaco.rememberLineDecorationsWidth
import com.dev.godkode.core.settings.Settings.Monaco.rememberLineNumbersMinChars
import com.dev.godkode.core.settings.Settings.Monaco.rememberMatchBrackets
import com.dev.godkode.core.settings.Settings.Monaco.rememberMonacoTheme
import com.dev.godkode.core.settings.Settings.Monaco.rememberWordBreak
import com.dev.godkode.core.settings.Settings.Monaco.rememberWrappingStrategy
import com.dev.godkode.editor.TextActionsWindow
import com.dev.godkode.editor.GodKodeEditor
import com.dev.godkode.editor.addBlockComment
import com.dev.godkode.editor.addSingleComment
import com.dev.godkode.editor.listener.OnExplainCodeListener
import com.dev.godkode.editor.listener.OnImportComponentListener
import com.dev.godkode.editor.textaction.EditorTextActionItem
import com.dev.godkode.editor.textaction.actionItems
import com.dev.godkode.editor.textaction.editorTextActionWindow
import com.dev.godkode.file.File
import com.dev.godkode.file.extension
import com.dev.godkode.keyboard.CommandPaletteManager
import com.dev.godkode.keyboard.createKeyEvent
import com.dev.godkode.keyboard.model.toShortcut
import com.dev.godkode.plugins.DialogManager
import com.dev.godkode.resources.R
import com.dev.godkode.ui.LocalToastHostState
import com.dev.godkode.ui.components.keyboard.CommandPalette
import com.dev.godkode.ui.screens.editor.ai.CodeExplanationSheet
import com.dev.godkode.ui.screens.editor.ai.ImportComponentsSheet
import com.dev.godkode.ui.screens.editor.components.Symbols
...
import com.godkode.plugins.event.KeyPressEvent
...
@Composable
private fun ConfigureFontSettings(editor: GodKodeEditor) {
...
@Composable
private fun ConfigureColorScheme(editor: GodKodeEditor) {
...
@Composable
private fun ConfigureIndentation(editor: GodKodeEditor) {
...
@Composable
private fun ConfigureMiscSettings(editor: GodKodeEditor) {
