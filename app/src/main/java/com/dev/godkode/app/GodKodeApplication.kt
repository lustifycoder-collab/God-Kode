...
import com.dev.godkode.activities.CrashActivity
import com.dev.godkode.core.EventManager
import com.dev.godkode.extensions.doIfNull
...
class GodKodeApplication : BaseApplication() {
    ...
    companion object {
        ...
        private const val TAG = "GodKodeApplication"

        private var appInstance: GodKodeApplication? = null

        init {
            System.loadLibrary("godkode")
        }

        @JvmStatic
        @Synchronized
        fun getInstance(): GodKodeApplication {
            doIfNull(appInstance) {
                appInstance = GodKodeApplication()
            }
