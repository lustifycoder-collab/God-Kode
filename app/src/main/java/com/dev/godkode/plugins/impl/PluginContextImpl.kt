...
import com.dev.godkode.activities.EditorActivity
import com.dev.godkode.app.rootView
import com.dev.godkode.core.EventManager
import com.dev.godkode.core.MenuManager
import com.dev.godkode.core.PanelManager
import com.dev.godkode.core.components.DraggableFloatingPanel
...
import com.dev.godkode.keyboard.model.Command
...
import com.godkode.plugins.Editor
import com.godkode.plugins.PluginContext
import com.godkode.plugins.Workspace
import com.godkode.plugins.command.EditorCommand
import com.godkode.plugins.dialog.DialogButtonClickListener
import com.godkode.plugins.editor.Position
import com.godkode.plugins.event.EventListener
import com.godkode.plugins.event.EventType
import com.godkode.plugins.menu.MenuItem
import com.godkode.plugins.network.HttpResponse
import com.godkode.plugins.panel.ComposeFactory
import com.godkode.plugins.panel.Panel
import com.godkode.plugins.panel.ViewFactory
import com.godkode.plugins.panel.ViewUpdater
...
class PluginContextImpl(
    ...
    override fun addMenu(menuItem: MenuItem) {
        ...
        menuManager.addMenu(
            com.dev.godkode.core.menu.MenuItem(
                menuItem.title,
                menuItem.id,
                visible = true,
                enabled = true,
    ...
    private inner class EditorListener : EditorImpl.Listener {
        ...
        override val editor: GodKodeEditor?
